...
import { Sparkles, ShieldCheck, Moon, Sun, AlertCircle } from 'lucide-react';
        ...
        <div className="w-full max-w-md bg-slate-800/90 border border-slate-700/80 p-8 rounded-3xl shadow-2xl animate-fade-in relative backdrop-blur">
          <div className="text-center mb-6">
            ...
            <h2 className="text-2xl font-bold text-white">
              {targetToken ? 'Connect to Private Space' : 'Create Your Private Space'}
            </h2>
            <p className="text-xs text-slate-400 mt-1">
              {targetToken
                ? 'Enter your name once to join your friend\'s permanent private space.'
                : 'Enter your name once to get your permanent private space link.'}
            </p>
          </div>
